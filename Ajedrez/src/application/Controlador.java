...
public class Controlador {
    ...
    private StackPane createCasilla(int f, int c, Pieza[][] piezas) {
        ...
        if((f+c)%2 == 0){ //si es par asigna casilla negra, sino es casilla blanca
        	fondo.setFill(javafx.scene.paint.Color.rgb(70,70,70)); //negro
        }else{
        	fondo.setFill(javafx.scene.paint.Color.rgb(247,243,231)); //blanco
        }

		// Agregar los elementos al StackPane
        casilla.getChildren().addAll(fondo,button);
